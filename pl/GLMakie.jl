...
# ╔═╡ 973c85f0-5260-11ed-0ddf-bf0b492b84d0
using GLMakie

# ╔═╡ bc290034-654b-414e-a91b-ac54a26bba10
begin
	f = Figure(backgroudcolor = :tomato, resolution = (800, 300))
	ax = Axis(f[1,1],
	    title = "Hello, Makie!",
	    xlabel = "time(s)",
	    ylabel = "quantity(g)"
...
# ╔═╡ 46366f52-3006-4e1f-92b1-f6ea87a636a5
## Hello GLMakie
